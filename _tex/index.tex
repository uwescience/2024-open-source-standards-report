...
and data-intensive discovery more generally depend on Findability,
...
their needs and interests into account. The present report seeks to
explore how OSS processes and tools have affected the development of
data and metadata standards. The report will triangulate common features
of a variety of use-cases, will identify some of the challenges and
pitfalls of this mode of standards development, and will make
...
require the data management plan that specifies how the data is shared.
...
Structure standard for neuroimaging data (Gorgolewski et al. 2016). The
latter in particular has adopted a
