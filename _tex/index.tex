...
\texttt{Desirable\ characteristics\ of\ data\ repositories\ for\ federally\ funded\ research\textquotesingle{}\textquotesingle{}\ \textbackslash{}cite\{nstc2022desirable\}.\ The\ report\ explicitly\ called\ out\ the\ importance\ of}allow{[}ing{]}
datasets and metadata to be accessed, downloaded, or exported from the
repository in widely used, preferably non-proprietary, formats
consistent with standards used in the disciplines the repository
...
\texttt{U.S.\ Leadership\ in\ AI:\ A\ Plan\ for\ Federal\ Engagement\ in\ Developing\ Technical\ Standards\ and\ Related\ Tools\textquotesingle{}\textquotesingle{}\ emphasized\ that\ -\/-\ specifically\ for\ the\ case\ of\ AI\ -\/-}U.S.
...
standards\ldots{} '\,' \cite{NIST2019}. The converging characteristics
of standards that arise from these reports suggest that considerable
thought needs to be given to the manner in which standards arise, so
